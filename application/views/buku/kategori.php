            ...
            <?php if(validation_errors()){?>
                <div class="alert alert-danger" role="alert">
                    ...
                    <?php
                        ...
                        class="badge badge-danger"><i class="fas fa-trash">
                        </i>Hapus</a>
                    </td>
                </tr>
                <?php } ?>
                        ...
                        <span aria-hidden="true">&times;</span>
                                    ...
                                    method="post"> <div class="modal-body">
                                        <div class="form-group">
                                            <select name="kategori" class="form-control form-control-
                                            user">
                                            <option value="">Pilih Kategori</option> <?php $k = ['Sains','Hobby','Komputer',
                                            'Komunikasi','Hukum','Agama','Populer','Bahasa','Komik'];
                                                    for ($i=0;$i<9;$i++) { ?>
                                                    <option value="<?= $k[$i];?>"><?= 
                                                    $k[$i];?></option>
                                                <?php } ?>
